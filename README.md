<div align="center">
  ...
  <p>A simple, fast and chromeless image viewer with native support for tiling window managers on linux. Its built in rust with egui. The project is still under development.</p>
</div>
